...
function RegisterUser() {
    ...
    var PhoneNumber = document.getElementById("phonenumber").value;
     if (FirstName == "") {
     ...
     else if ($("#TerritoryId").find(':selected').text() == "Select Territory") {
         iziToast.warning({
             title: 'Warning!',
     ...
     else if ($("#RoleId").find(':selected').text() == "Select Role") {
         iziToast.warning({
             title: 'Warning!',
        ...
        if (valid == true) {
            var RegisterViewModel = {
                FirstName: FirstName,
                LastName: LastName,
                TerritoryId: document.getElementById("TerritoryId").value,
